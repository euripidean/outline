...
function NavBar(props) {
  ...
  const currentProject = useSelector((state) => state.outline.activeProject);
  ...
  const handleEditProjectClick = () => {
    dispatch(openModal("update-project"));
  };
          ...
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
            {currentProject && (
              <li className="flex items-center">
                ...
                >
                  Edit Project <i className="fa-solid fa-pen-to-square"></i>
                </button>
              </li>
            )}
            <li className="flex items-center">
